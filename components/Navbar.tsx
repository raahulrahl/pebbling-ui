...
const GitHubStars = () => {
  ...
  return (
    <Link
      ...
      className="flex items-center space-x-2 text-sm font-medium text-gray-500 hover:text-gray-900 border border-gray-300 rounded-md px-2 py-1 hover:border-gray-500 transition-colors"
      target="_blank"
    ...
    <header className="border-b border-gray-200 py-4 relative">
      ...
      >
        <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
          ...
          <Link
            href="#"
            className="text-sm font-medium text-gray-500 hover:text-gray-900 py-2 text-center"
          >
            COMMUNITY
          </Link>
          <Link
