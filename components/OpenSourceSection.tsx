      ...
      <div className="container px-4 md:px-6 mx-auto max-w-5xl">
        ...
        >
          <h2 className="text-4xl font-bold tracking-tighter sm:text-5xl text-center my-2">
            <span className="bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 dark:bg-gradient-to-br dark:from-purple-500 dark:via-purple-400 dark:to-indigo-500 bg-clip-text text-transparent inline-block font-extrabold">Proudly open-source</span>
          </h2>
