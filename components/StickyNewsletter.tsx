          ...
          <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <form onSubmit={handleSubmit} className="flex flex-1 max-w-xs space-x-2">
              <input
                ...
                className="flex-1 h-8 px-3 py-1 text-xs bg-background text-foreground placeholder:text-muted-foreground rounded-md border border-border focus:outline-none focus:ring-1 focus:ring-purple-400 focus:border-transparent"
              />
              <Button 
                type="submit"
                size="sm"
                disabled={status === "loading"}
                className="h-8 bg-purple-600 hover:bg-purple-700 text-xs px-3 py-1"
              >
